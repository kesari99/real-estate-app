...
const handleSubmit = (e) => {
    ...
    const fetchListing = async () => {
        ...
        const res = await fetch(`https://kesari-real-estate-app.onrender.com/api/listing/get?${searchQuery}`)
...
const onShowMoreClick = async () => {
    ...
    const res = await fetch(`https://kesari-real-estate-app.onrender.com/api/listing/get?${searhcQuery}`)
    const data = await res.json()
