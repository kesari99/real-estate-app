...
export default function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
        ...
        const res = await fetch(`https://kesari-real-estate-app.onrender.com/api/user/update/${currentUser._id}`, {
          method:'POST',
          headers:{
  ...
  const handleDeleteUser = async () => {
    try{
      ...
      const res = await fetch(`https://kesari-real-estate-app.onrender.com/api/user/delete/${currentUser._id}`, {
        method:'DELETE',
        headers:{
          'Content-Type':'application/json'
        },
  ...
  const handleSignOut = async () => {
    ...
    try{
      ...
      const res = await fetch('https://kesari-real-estate-app.onrender.com/api/auth/signout')
      const data = await res.json()
      if(data.success === false){
  ...
  const handleShowListing = async () => {
    try{
      ...
      const res = await fetch(`https://kesari-real-estate-app.onrender.com/api/user/listings/${currentUser._id}`)
      const data = await res.json()
      if(data.success == false){
  ...
  const handleDeleteList = async (id) => {
    ...
    try{
      const res = await fetch(`https://kesari-real-estate-app.onrender.com/api/listing/delete/${id}`, {
        method:'DELETE',
